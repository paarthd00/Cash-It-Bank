    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.balance < 0)
                {
                    ModelState.AddModelError(string.Empty, "Balance cannot be negative");
                    return Page();
                }
                var userExits = await clientAccountRepo.getDetailsthruEmail(Input.Email);
                if (userExits != null)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    _context.ClientsAccount.Add(clientAccount);
