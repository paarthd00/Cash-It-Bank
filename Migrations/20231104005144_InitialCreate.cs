    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVM", x => x.ClientID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsAccount", x => new { x.clientID, x.accountNum });
                    table.ForeignKey(
                        name: "FK_ClientsAccount_BankAccounts_accountNum",
                        column: x => x.accountNum,
                        principalTable: "BankAccounts",
                        principalColumn: "accountNum",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientsAccount_Clients_clientID",
                        column: x => x.clientID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientsAccount_accountNum",
                table: "ClientsAccount",
                column: "accountNum");
        }
